...
urlpatterns = [
    ...
    ### Views accessible to aconymous users ###
    ...
    url(r'^matches/$', views_auth.matches_view, name="matches_page"),
    ...
    url(r'^api/v1/filter-members.json$', views_api.filter_members_view, name="filter_members"),
]
...
api_urlpatterns = [
    ...
    url(r'^api/v1/pms/(?P<username>' + settings.RSTR_USERNAME + r')$', views_api.pms_list, name='pms_list_api'),

    # Show all users that subscribe to a specific subreddit.
    url(r'^api/v1/r/(?P<sr>' + settings.RSTR_SR_NAME + r')$', views_api.sr_user_list, name="sr_user_list_api"),
    ...
    url(r'^api/v1/flag/(?P<flag>(like|nope))/(?P<username>' + settings.RSTR_USERNAME + r')$', views_api.flag_api, name="flag_api"),
]
...
if settings.DEBUG:
    ...
    urlpatterns += static('/app/', document_root='/home/chris/dev/new/dater5/dtr5-material/dist/')
    urlpatterns += static('/node_modules/', document_root='/home/chris/dev/new/dater5/dtr5-material/node_modules/')
    urlpatterns += static('/s/', document_root=path.join(settings.BASE_DIR, 'avatars/s/'))
    urlpatterns += static('/m/', document_root=path.join(settings.BASE_DIR, 'avatars/m/'))
